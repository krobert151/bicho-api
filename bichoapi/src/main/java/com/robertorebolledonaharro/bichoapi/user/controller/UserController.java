...
import com.robertorebolledonaharro.bichoapi.user.dto.UserResponse;
...
public class UserController {
    ...
    public ResponseEntity<String> createPersonWithUserRole(@Valid @RequestBody CreateUserRequest createUserRequest){
        User user = userService.createPersonWithUserRole(createUserRequest);
